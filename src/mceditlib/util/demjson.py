...
class json_options(object):
    ...
    def reset_to_defaults(self):
        ...
        self._plain_attrs = ['leading_zero_radix',
                             ...
                             'max_items_per_line',
                             'py2str_encoding',
                             'encode_quoted_property_names',  # mcedit
                             ]
        ...
        # For command block output
        self.encode_quoted_property_names = True
...
class JSON(object):
    ...
    def encode_string(self, s, state, quote=True):
    ...
    def _do_encode(self, obj, state, quoteStrings=True):
        ...
        if obj_classification == 'null':
            ...
            self.encode_string( obj, state, quoteStrings)
        ...
        if it is not None:
            ...
            try: # while not StopIteration
                ...
                while True:
                    ...
                    self._do_encode( obj2, substate, self.options.encode_quoted_property_names )
                    if isdict:
